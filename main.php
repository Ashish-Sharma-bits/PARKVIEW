...
<header>
<section class="logo">
<p><center> PARKVIEW PARKINGS </center></p>
</section>
    <nav>
      <ul class="nav">
        ...
        <li class="dropdown">
          ...
          <ul class="large">
            <li><a href="region-1.php">C.P. - Cars Only</a></li>
            <li><a href="region-2.php">Akshar dham - Cars Only</a></li>
            <li><a href="region-3.php">Nehru place -  Cars and Lorries</a></li>
            <li><a href="region-4.php">Laxmi nagar - Lorries Only</a></li>
			<li><a href="region-5.php">Dilshad garden - Cars Only</a></li>
			<li><a href="region-6.php">Rohni  - PSV Only</a></li>
          </ul>
        </li>
